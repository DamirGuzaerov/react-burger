...
describe('Redux user orders reducer', () => {
		...
		it('should set ws status online when dispatch wsOpen', function () {
				const state = userOrdersReducer(initialState, wsOpen);
		...
		it('should set ws status offline when dispatch wsClose', function () {
				const state = userOrdersReducer(initialState, wsClose);
		...
		it('should set data when dispatch wsMessage', function () {
				...
				const state = userOrdersReducer(initialState, wsMessage({orders: testOrders, total: 1, totalToday: 1, success: true}));
		...
		it('should set error when dispatch wsError', function () {
				const state = userOrdersReducer(initialState, wsError('Error'));
